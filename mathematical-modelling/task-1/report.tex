...
Skirtingos spalvos naudojamos vaizduoti sprendinius su skirtingomis $C$ reikšmėmis.
Vientisos linijos vaizduoja sprendinį gautą analitiniu metodu, kuris aprašytas šiame dokumente.
Praretinti taškai žymi sprendinį, kuris buvo apskaičiuotas skaitiniu metodu.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{1.png}
    \caption{Lygties $2+y^2+\sqrt{5-x^2}yy'=0$ integralinės kreivės su $C$ reikšmėmis $0.5, 1, 2, 4$}
    \label{fig:pvz1}
\end{figure}
